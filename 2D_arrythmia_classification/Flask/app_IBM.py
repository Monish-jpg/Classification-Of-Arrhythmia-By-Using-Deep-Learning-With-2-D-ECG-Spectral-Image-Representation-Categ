...
model=tf.keras.models.load_model('PREDICTION_MODEL.h5')#loading the model #to load our trained model
...
def upload():
    if request.method=='POST':
        ...
        x=tf.keras.utils.img_to_array(img)#converting image to array
